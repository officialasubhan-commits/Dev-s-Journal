...
export default function CourseDetailsClient({ course, similarCourses }: { course: Course, similarCourses: Course[] }) {
  const [openSection, setOpenSection] = useState<string | null>(course?.curriculum?.[0]?.id || null);
